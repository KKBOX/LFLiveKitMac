...
- (void)initPath:(NSString *)path Height:(int)height andWidth:(int)width bitrate:(int)bitrate
{
	...
	NSDictionary *settings = @{AVVideoCodecKey: AVVideoCodecH264, AVVideoWidthKey: @(width), AVVideoHeightKey: @(height), AVVideoCompressionPropertiesKey: @{AVVideoAverageBitRateKey: @(self.bitrate), AVVideoMaxKeyFrameIntervalKey: @(30 * 2), AVVideoProfileLevelKey: AVVideoProfileLevelH264Baseline41, AVVideoAllowFrameReorderingKey: @NO,}};
