...
public:
	...
	enum eNALType
	{
		NAL_Slice = 1, NAL_PartitionA = 2, NAL_PartitionB = 3, NAL_PartitionC = 4, NAL_IDR_Slice = 5, NAL_SEI = 6, NAL_Sequence_Params = 7, NAL_Picture_Params = 8, NAL_AUD = 9,
	};
...
{
public:
	LFSliceHeader(int nBitsFrame) : m_framenum(0), m_nBitsFrame(nBitsFrame) {
	}
